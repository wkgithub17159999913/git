...
public class WeatherBasicParameter {
	private String dsid;
	private String year;
	...
	public WeatherBasicParameter(String dsid, String year, String month, String day, String longiutude, String latitude,
			String fieldAltitude, String airSensorAltitude, String serverType, String deviceLogo, String deviceId,
			String retain) {
		super();
		this.dsid = dsid;
		this.year = year;
